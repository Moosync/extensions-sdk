...
@extism.import_fn("extism:host/user", "system_time")
def system_time() -> int: ...
...
def send_main_command_(
    cmd: extensions_pb2.MainCommand,
...
class Api:
    def get_song(self, options: songs_pb2.GetSongOptions) -> List[songs_pb2.Song]:
        req = extensions_pb2.MainCommand(
            get_song=extensions_pb2.GetSongRequest(options=options)
        )
    ...
    def get_current_song(self) -> Optional[songs_pb2.Song]:
        req = extensions_pb2.MainCommand(
            get_current_song=extensions_pb2.GetCurrentSongRequest()
        )
        resp = send_main_command_(req)
    ...
    def get_player_state(self) -> extensions_pb2.PlayerState:
        req = extensions_pb2.MainCommand(
            get_player_state=extensions_pb2.GetPlayerStateRequest()
        )
        resp = send_main_command_(req)
    ...
    def get_preference(
        self, data: extensions_pb2.PreferenceData
    ) -> extensions_pb2.PreferenceData:
        req = extensions_pb2.MainCommand(
            get_preference=extensions_pb2.GetPreferenceRequest(data=data)
        )
        resp = send_main_command_(req)
    ...
    def get_secure(
        ...
        req = extensions_pb2.MainCommand(
            get_secure=extensions_pb2.GetSecureRequest(data=data)
        )
        resp = send_main_command_(req)
    ...
    def set_preference(self, data: extensions_pb2.PreferenceData) -> bool:
        req = extensions_pb2.MainCommand(
            set_preference=extensions_pb2.SetPreferenceRequest(data=data)
        )
        resp = send_main_command_(req)
    ...
    def set_secure(self, data: extensions_pb2.PreferenceData) -> bool:
        req = extensions_pb2.MainCommand(
            set_secure=extensions_pb2.SetSecureRequest(data=data)
        )
        resp = send_main_command_(req)
    ...
    def add_songs(self, songs: List[songs_pb2.Song]) -> List[songs_pb2.Song]:
        req = extensions_pb2.MainCommand(
            add_songs=extensions_pb2.AddSongsRequest(songs=songs)
        )
        resp = send_main_command_(req)
    ...
    def remove_song(self, song: songs_pb2.Song) -> bool:
        req = extensions_pb2.MainCommand(
            remove_song=extensions_pb2.RemoveSongRequest(song=song)
        )
        resp = send_main_command_(req)
    ...
    def update_song(self, song: songs_pb2.Song) -> songs_pb2.Song:
        req = extensions_pb2.MainCommand(
            update_song=extensions_pb2.UpdateSongRequest(song=song)
        )
        resp = send_main_command_(req)
    ...
    def add_playlist(self, playlist: songs_pb2.Playlist) -> str:
        req = extensions_pb2.MainCommand(
            add_playlist=extensions_pb2.AddPlaylistRequest(playlist=playlist)
        )
        resp = send_main_command_(req)
    ...
    def add_to_playlist(self, playlist_id: str, songs: List[songs_pb2.Song]) -> bool:
        req = extensions_pb2.MainCommand(
            add_to_playlist=extensions_pb2.AddToPlaylistRequest(
    ...
    def register_oauth(self, url: str) -> bool:
        req = extensions_pb2.MainCommand(
            register_oauth=extensions_pb2.RegisterOauthRequest(url=url)
        )
        resp = send_main_command_(req)
    ...
    def open_external_url(self, url: str) -> bool:
        req = extensions_pb2.MainCommand(
            open_external_url=extensions_pb2.OpenExternalUrlRequest(url=url)
        )
        resp = send_main_command_(req)
    ...
    def unregister_user_preferences(self, keys: List[str]) -> bool:
        req = extensions_pb2.MainCommand(
            unregister_user_preference=extensions_pb2.UnregisterUserPreferenceRequest(
                keys=keys
            )
        )
        resp = send_main_command_(req)
...
class Extension:
    ...
    def get_provider_scopes(
        self, _: extensions_pb2.GetProviderScopesRequest
    ) -> extensions_pb2.GetProviderScopesResponse:
        return extensions_pb2.GetProviderScopesResponse()

    def get_playlists(
        self, req: extensions_pb2.RequestedPlaylistsRequest
    ) -> extensions_pb2.RequestedPlaylistsResponse:
        raise NotImplementedError()

    def get_playlist_content(
        self, req: extensions_pb2.RequestedPlaylistSongsRequest
    ) -> extensions_pb2.RequestedPlaylistSongsResponse:
        raise NotImplementedError()

    def get_playlist_from_url(
        self, req: extensions_pb2.RequestedPlaylistFromUrlRequest
    ) -> extensions_pb2.RequestedPlaylistFromUrlResponse:
        raise NotImplementedError()

    def get_playback_details(
        self, req: extensions_pb2.PlaybackDetailsRequestedRequest
    ) -> extensions_pb2.PlaybackDetailsRequestedResponse:
        raise NotImplementedError()

    def get_search(
        self, req: extensions_pb2.RequestedSearchResultRequest
    ) -> extensions_pb2.RequestedSearchResultResponse:
        raise NotImplementedError()

    def get_recommendations(
        self, req: extensions_pb2.RequestedRecommendationsRequest
    ) -> extensions_pb2.RequestedRecommendationsResponse:
        raise NotImplementedError()

    def get_song_from_url(
        self, req: extensions_pb2.RequestedSongFromUrlRequest
    ) -> extensions_pb2.RequestedSongFromUrlResponse:
        raise NotImplementedError()

    def handle_custom_request(
        self, req: extensions_pb2.CustomRequest
    ) -> extensions_pb2.CustomRequestResponse:
        raise NotImplementedError()

    def get_artist_songs(
        self, req: extensions_pb2.RequestedArtistSongsRequest
    ) -> extensions_pb2.RequestedArtistSongsResponse:
        raise NotImplementedError()

    def get_album_songs(
        self, req: extensions_pb2.RequestedAlbumSongsRequest
    ) -> extensions_pb2.RequestedAlbumSongsResponse:
        raise NotImplementedError()

    def get_song_from_id(
        self, req: extensions_pb2.RequestedSongFromIdRequest
    ) -> extensions_pb2.RequestedSongFromIdResponse:
        raise NotImplementedError()

    def on_queue_changed(
        self, req: extensions_pb2.SongQueueChangedRequest
    ) -> extensions_pb2.SongQueueChangedResponse:
        raise NotImplementedError()

    def on_volume_changed(
        self, req: extensions_pb2.VolumeChangedRequest
    ) -> extensions_pb2.VolumeChangedResponse:
        raise NotImplementedError()

    def on_player_state_changed(
        self, req: extensions_pb2.PlayerStateChangedRequest
    ) -> extensions_pb2.PlayerStateChangedResponse:
        raise NotImplementedError()

    def on_song_changed(
        self, req: extensions_pb2.SongChangedRequest
    ) -> extensions_pb2.SongChangedResponse:
        raise NotImplementedError()

    def on_seeked(
        self, req: extensions_pb2.SeekedRequest
    ) -> extensions_pb2.SeekedResponse:
        raise NotImplementedError()

    def on_preferences_changed(
        self, req: extensions_pb2.PreferenceChangedRequest
    ) -> extensions_pb2.PreferenceChangedResponse:
        raise NotImplementedError()

    def on_song_added(
        self, req: extensions_pb2.SongAddedRequest
    ) -> extensions_pb2.SongAddedResponse:
        raise NotImplementedError()

    def on_song_removed(
        self, req: extensions_pb2.SongRemovedRequest
    ) -> extensions_pb2.SongRemovedResponse:
        raise NotImplementedError()

    def on_playlist_added(
        self, req: extensions_pb2.PlaylistAddedRequest
    ) -> extensions_pb2.PlaylistAddedResponse:
        raise NotImplementedError()

    def on_playlist_removed(
    ...
    ) -> extensions_pb2.PerformAccountLoginResponse:
        raise NotImplementedError()

    def scrobble(
        self, req: extensions_pb2.ScrobbleRequest
    ) -> extensions_pb2.ScrobbleResponse:
        raise NotImplementedError()

    def oauth_callback(
        self, req: extensions_pb2.OauthCallbackRequest
    ) -> extensions_pb2.OauthCallbackResponse:
        raise NotImplementedError()

    def get_song_context_menu(
        self, req: extensions_pb2.RequestedSongContextMenuRequest
    ) -> extensions_pb2.RequestedSongContextMenuResponse:
        raise NotImplementedError()

    def get_playlist_context_menu(
        self, req: extensions_pb2.RequestedPlaylistContextMenuRequest
    ) -> extensions_pb2.RequestedPlaylistContextMenuResponse:
        raise NotImplementedError()

    def on_context_menu_action(
        self, req: extensions_pb2.ContextMenuActionRequest
    ) -> extensions_pb2.ContextMenuActionResponse:
        raise NotImplementedError()

    def get_lyrics(
        self, req: extensions_pb2.RequestedLyricsRequest
    ) -> extensions_pb2.RequestedLyricsResponse:
        raise NotImplementedError()
...
def handle_extension_command():
    ...
    if number == extensions_pb2.ExtensionCommand.GET_PROVIDER_SCOPES_FIELD_NUMBER:
        response.get_provider_scopes.CopyFrom(
            instance.get_provider_scopes(cmd.get_provider_scopes)
        )
    elif number == extensions_pb2.ExtensionCommand.REQUESTED_PLAYLISTS_FIELD_NUMBER:
        response.requested_playlists.CopyFrom(
            instance.get_playlists(cmd.requested_playlists)
        )
    elif (
        number == extensions_pb2.ExtensionCommand.REQUESTED_PLAYLIST_SONGS_FIELD_NUMBER
    ):
        response.requested_playlist_songs.CopyFrom(
            instance.get_playlist_content(cmd.requested_playlist_songs)
        )
        ...
        response.song_queue_changed.CopyFrom(
            instance.on_queue_changed(cmd.song_queue_changed)
        )
        ...
        response.player_state_changed.CopyFrom(
            instance.on_player_state_changed(cmd.player_state_changed)
        )
        ...
        response.preference_changed.CopyFrom(
            instance.on_preferences_changed(cmd.preference_changed)
        )
    elif (
        number
        == extensions_pb2.ExtensionCommand.PLAYBACK_DETAILS_REQUESTED_FIELD_NUMBER
    ):
        response.playback_details_requested.CopyFrom(
            instance.get_playback_details(cmd.playback_details_requested)
        )
    elif number == extensions_pb2.ExtensionCommand.CUSTOM_REQUEST_FIELD_NUMBER:
        response.custom_request.CopyFrom(
            instance.handle_custom_request(cmd.custom_request)
        )
    elif number == extensions_pb2.ExtensionCommand.REQUESTED_SONG_FROM_URL_FIELD_NUMBER:
        response.requested_song_from_url.CopyFrom(
            instance.get_song_from_url(cmd.requested_song_from_url)
        )
    elif (
        number
        == extensions_pb2.ExtensionCommand.REQUESTED_PLAYLIST_FROM_URL_FIELD_NUMBER
    ):
        response.requested_playlist_from_url.CopyFrom(
            instance.get_playlist_from_url(cmd.requested_playlist_from_url)
        )
    elif number == extensions_pb2.ExtensionCommand.REQUESTED_SEARCH_RESULT_FIELD_NUMBER:
        response.requested_search_result.CopyFrom(
            instance.get_search(cmd.requested_search_result)
        )
    elif (
        number == extensions_pb2.ExtensionCommand.REQUESTED_RECOMMENDATIONS_FIELD_NUMBER
    ):
        response.requested_recommendations.CopyFrom(
            instance.get_recommendations(cmd.requested_recommendations)
        )
        ...
        response.requested_artist_songs.CopyFrom(
            instance.get_artist_songs(cmd.requested_artist_songs)
        )
    elif number == extensions_pb2.ExtensionCommand.REQUESTED_ALBUM_SONGS_FIELD_NUMBER:
        response.requested_album_songs.CopyFrom(
            instance.get_album_songs(cmd.requested_album_songs)
        )
        ...
        response.playlist_removed.CopyFrom(
            instance.on_playlist_removed(cmd.playlist_removed)
        )
    elif number == extensions_pb2.ExtensionCommand.REQUESTED_SONG_FROM_ID_FIELD_NUMBER:
        response.requested_song_from_id.CopyFrom(
            instance.get_song_from_id(cmd.requested_song_from_id)
        )
        ...
        number
        == extensions_pb2.ExtensionCommand.REQUESTED_SONG_CONTEXT_MENU_FIELD_NUMBER
    ):
        response.requested_song_context_menu.CopyFrom(
            instance.get_song_context_menu(cmd.requested_song_context_menu)
        )
    elif (
        number
        == extensions_pb2.ExtensionCommand.REQUESTED_PLAYLIST_CONTEXT_MENU_FIELD_NUMBER
    ):
        response.requested_playlist_context_menu.CopyFrom(
            instance.get_playlist_context_menu(cmd.requested_playlist_context_menu)
        )
